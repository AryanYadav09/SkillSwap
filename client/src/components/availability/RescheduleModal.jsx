...
export default function RescheduleModal({ meeting, onClose, onRescheduled }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg max-h-[80vh] rounded-2xl border border-indigo-100 bg-white shadow-xl overflow-hidden flex flex-col">
                      ...
                      return (
                        <button
                          ...
                          className={`rounded-xl border px-4 py-2.5 text-sm font-bold transition-all ${
                            isSelected
                              ? "border-indigo-200 bg-indigo-50 border border-indigo-100 text-indigo-600 shadow-glow"
                              : "border-line bg-white text-gray-700 hover:border-indigo-300 hover:bg-indigo-50/50"
                          }`}
